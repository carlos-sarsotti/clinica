...
$graph->clearTheme();
$graph->SetScale('intint',0,11,-5,5);
$graph->SetMargin(10,150,30,30);
$graph->SetMarginColor('lightblue');
$graph->SetShadow(0);
$graph->yaxis->SetColor('black');
$graph->xaxis->SetColor('black');
$graph->title->Set("SCORE-Z PERIMETRO");
...
$datax[1]=array($azcorezcabe);
$datax[2]=array($azcorezbrar);
$datax[3]=array($azcorezbraf);
$datax[4]=array($azcorezante);
$datax[5]=array($azcoreztórm);
$datax[6]=array($azcorezcint);
$datax[7]=array($azcorezcade);
$datax[8]=array($azcorezmuss);
$datax[9]=array($azcorezmusm);
$datax[10]=array($azcorezpan1);
...
$line[1] = 'Cabeza';
$line[2] = 'Brazo Relajado  ';
$line[3] = 'Brazo Flexionado';
$line[4] = 'Antebrazo       ';
$line[5] = 'Torax Mesoester.';
$line[6] = 'Cintura(minima)';
$line[7] = 'Cadera (maxima)';
$line[8] = 'Muslo(superior)';
$line[9] = 'Muslo(medial)  ';
$line[10] = 'Pantorrilla (m)';
