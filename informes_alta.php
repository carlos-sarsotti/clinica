	...
	<div class="row" >
		<div class="col-md-12">
				<div class="widget box">
					<form name=frm method="GET" action="informes_alta.php">						
					<input type="hidden" name="ingresar">
					<div class="widget-content no-padding">
					<span class="black"><h4>Busqueda de Informes</h4></span>
...
function limpia(){
window.open('informes_alta.php' ,'_top')
}
$(function(){           
...
while($row = mysqli_fetch_assoc($result))
	...
	{		
					?>
					   ...
					   <div class="col-md-8">
						<h2><i class="icon-male"></i>INFORME DEL PACIENTE </h2>
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-male"></i> Informe Paciente Alta</h4>
	             ...
	             <form name=frm1 id=frm1 action="informes_alta.php"  method="POST" >
						...
						<table class="table" width="50%" align="center">
						 ...
						 <th  class="col-md-3"></th><th class="col-md-5"><button class='btn btn-success' onclick="entra1($('#id_paciente').val());return false;">Continuar a Informe</button></td>
						</table>
