...
$graph->title->Set("SCORE-Z PLIEGUES");
...
$datax[1]=array($azcoreztríc);
$datax[2]=array($azcorezsube);
$datax[3]=array($azcorezsupr);
$datax[4]=array($azcorezabdo);
$datax[5]=array($azcorezmusl);
$datax[6]=array($azcorezpan2);
