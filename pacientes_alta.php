...
$resultado="";
$fechahoy = date("Y-m-d");
$query =  "update turnos_pacientes set estado=3 where id_turnos='$id_turnos'";
$result = mysqli_query($bd,$query) or die("error en consulta") ;

$query =  "select * FROM turnos_pacientes WHERE id_turnos='$id_turnos'";
$result = mysqli_query($bd, $query) ;
