	...
	<div class="row" >
		<div class="col-md-12">
				<div class="widget box">
					<form name=frm method="GET" action="pacientes_modif.php">						
					<input type="hidden" name="ingresar">
					<div class="widget-content no-padding">
					<span class="black"><h4>Modificar Registro Paciente </h4></span>					
...
function limpia(){
window.open('pacientes_modif.php' ,'_top')
}
$(function(){           
...
include("conexion-cupea.php");
$query =  "update agenda_pacientes set dni='$dni',apellido='$apellido',nombre='$nombre',sexo='$genero1',telef='$telef',correo='$correo',fecha_nac='$fechan1',obra_social='$obrasoc' where id_paciente='$id_paciente1' ";
$result = mysqli_query($bd,$query) ;
//echo $query;
?>
<div class="row">
...
while($row = mysqli_fetch_assoc($result))
	...
	$fecha_nac3=$row['fecha_nac'];
	$tmpf1 = str_replace ('-', "@", $fecha_nac3);
	$tmpf1 =  explode ("@", $tmpf1);
	$anod1 = $tmpf1[0];
	$mesd1 = $tmpf1[1];
	$diad1 = $tmpf1[2];
	$fechan = $diad1."-".$mesd1."-".$anod1;
	}
	...
	{		
					   ...
					   <div class="col-md-8">
						...
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-male"></i> Paciente Modificacion</h4>
	             ...
	             <form name=frm1 id=frm1 action="pacientes_modif.php"  method="POST" >
...
function checkEmail() {
    ...
    return false;
					   ...
					   <div class="col-md-8">
						...
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-male"></i> Datos Paciente Inexistentes</h4>
								<!--<div class="toolbar no-padding">
									<div class="btn-group">
										<span class="btn btn-xs widget-collapse"><i class="icon-angle-down"></i></span>
									</div>
