...
$graph->clearTheme();
$graph->SetScale('intint',0,6,-5,5);
$graph->SetMargin(60,60,60,60);
$graph->SetMarginColor('lightblue');
$graph->SetShadow(0);
$graph->yaxis->SetColor('black');
$graph->xaxis->SetColor('black');
$graph->title->Set("MASAS CORPORALES");
...
$datax[1]=array($szcuerpo1);
$datax[2]=array($szresidual1);
$datax[3]=array($szmuscular1);
$datax[4]=array($szadiposa1);
$datax[5]=array($calcu2);
...
$sp1->mark->SetType(MARK_IMG_MBALL,$color[$i],1.3);
// Add the plot to the graph
$sp1->value->SetFont(FF_FONT1,FS_BOLD,8);
...
$graph->legend->SetPos(0.04,0.98,'left','bottom');
// ... and send to browser
$graph->Stroke();
