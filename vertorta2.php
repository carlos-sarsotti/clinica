...
$graph->clearTheme();
$graph->SetScale('intint',0,3,-4,4);
$graph->SetMargin(10,140,30,30);
$graph->SetMarginColor('lightblue');
$graph->SetShadow(0);
$graph->yaxis->SetColor('black');
$graph->xaxis->SetColor('black');
$graph->title->Set("SCORE-Z BASICOS");
...
$datax[1]=array($azcorezpeso);
$datax[2]=array($azcoreztals);
