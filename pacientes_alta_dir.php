	...
	<div class="row" >
		<div class="col-md-12">
				<div class="widget box">
					<form name=frm method="GET" action="pacientes_alta_dir.php">						
					<input type="hidden" name="ingresar">
					<div class="widget-content no-padding">
					<span class="black"><h4>Registro Alta de Pacientes</h4></span>
...
function limpia(){
window.open('pacientes_alta_dir.php' ,'_top')
}
$(function(){           
...
include("conexion-cupea.php");
$query =  "insert into agenda_pacientes (dni,apellido,nombre,sexo,telef,correo,fecha,fecha_alta,fecha_baja,estado,fecha_nac,obra_social)values('$dni','$apellido','$nombre','$genero','$telef','$correo','$hora','$fechahoy','0000-00-00','0','$fechan1','$obrasoc')";
$result = mysqli_query($bd,$query) ;
...
while($row = mysqli_fetch_assoc($result))
	...
	{		
					   ...
					   <div class="col-md-8">
						...
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-male"></i> Paciente Alta</h4>
	             ...
	             <form name=frm1 id=frm1 action="pacientes_alta_dir.php"  method="POST" >
						<input type="hidden" name="CQ" value="<?=$CqNum?>" />
						<div class="widget-content no-padding">
						<table class="table" width="50%" align="center">
						 <th  class="col-md-3">Apellido:</th> <th class="col-md-5"><input type="text" name="apellido"  value="<?php echo $apellido;?>" class="form-control required"  onfocus='selecciona_value(this)' style="text-transform: uppercase;" required></th><tr>
						 <th  class="col-md-3">Nombre:</th> <th class="col-md-5"><input type="text" name="nombre"  value="<?php echo $nombre;?>" class="form-control required"  onfocus='selecciona_value(this)' style="text-transform: uppercase;"  required></th><tr>
						 ...
						 <th  class="col-md-3"></th><th class="col-md-5"><input type="submit" class="btn btn-primary" value="Grabar"></th><tr>			 
						</table>
...
function checkEmail() {
    ...
    return false;
					   ...
					   <div class="col-md-8">
						...
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-male"></i> Paciente dado de Alta Anteriormente</h4>
								<!--<div class="toolbar no-padding">
									<div class="btn-group">
										<span class="btn btn-xs widget-collapse"><i class="icon-angle-down"></i></span>
									</div>
							...
							<div class="widget-content no-padding">
						<input type="hidden" name="id_paciente1" id="id_paciente1" value="<?php echo $id_paciente1;?>">							
						<table class="table" width="50%" align="center">
						 ...
						 <th  class="col-md-3"></th><th class="col-md-5"><button class='btn btn-primary' onclick="entra2($('#id_paciente1').val());return false;">Continuar a Informe</button></td>
						</table>
