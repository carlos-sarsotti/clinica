	...
	<div class="row" >
		<div class="col-md-12">
				<div class="widget box">
					<form name=frm method="GET" action="informes_buscar.php">						
...
function limpia(){
window.open('informes_buscar.php' ,'_top')
}
$(function(){           
...
<?php             
					...
					while($row = mysqli_fetch_assoc($result))
						...
						?>
						<td><button class='btn btn-success' onclick="entra3($('#id_informe<?php echo $contar;?>').val());return false;">Imprimir Informe<?php echo "-".$contar;?></button></td>
						<?php
						echo "</tr>";
						}
?>
